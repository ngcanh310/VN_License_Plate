"""
Preprocess.py
Mục đích của chương trình này là tạo ra ảnh xám và ảnh nhị phân từ ảnh gốc, 
nhằm làm nổi bật chi tiết của biển số xe, 
giúp nhận diện hoặc xử lý dễ dàng hơn
"""
import cv2
import numpy as np
import math
